...
export default function encodeCodabar(text) {
  ...
  const firstIsStart = !!codabarStartsAndStops[text[0]];
  const lastIsStop = !!codabarStartsAndStops[text[text.length - 1]];
